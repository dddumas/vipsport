...
<div id="footer-wrapper">
		...
		<?php } ?> 
         ...
         <div class="copyright-wrapper">
            <div class="container">
            <div class="copyright-txt"><?php esc_attr_e('&copy; 2016','skt-yogi-lite');?> <?php bloginfo('name'); ?>. <?php esc_attr_e('All Rights Reserved', 'skt-yogi-lite');?> <?php printf('<a href="'.esc_url(SKT_FREE_THEME_URL).'" rel="nofollow" target="_blank">SKT Yogi Lite</a>' ); ?></div>
            </div>
		<div class="clear"></div>
</div>
    </div><!--end .footer-->
