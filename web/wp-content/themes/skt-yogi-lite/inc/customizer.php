...
function skt_yogi_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control($wp_customize,'color_scheme',array(
			...
			'description' => __( 'More color options in PRO Version', 'skt-yogi-lite' ),			
			'section' => 'colors',
...
// Home Three Boxes Section 	
	...
	$wp_customize->add_section('slider_section',array(
		'title'	=> __('Slider Settings','skt-yogi-lite'),
		 'description' => __( 'Add slider images here. <br><strong>More slider settings available in PRO Version.', 'skt-yogi-lite' ),			
		'priority'		=> null
	));	
	// Slide Image 1
...
// Slide Image 4
	...
	$wp_customize->add_section('social_sec',array(
			...
			'description' => __( 'More social icon available in PRO Version.', 'skt-yogi-lite' ),			
			'priority'		=> null
	));
